...
Pessoa::Pessoa(const std::string& nome, const uint64_t cpf) : Pessoa{nome} { setCpf(cpf); }

Pessoa::Pessoa(const std::string& nome, const uint64_t cpf, const unsigned short int idade)
    : Pessoa{nome, cpf} {
    setIdade(idade);
}
